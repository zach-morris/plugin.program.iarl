...
import resources.lib.xbmcswift2b
from resources.lib.xbmcswift2b import xbmc, xbmcaddon, xbmcplugin, xbmcgui
from resources.lib.xbmcswift2b.storage import TimedStorage
from resources.lib.xbmcswift2b.logger import log
from resources.lib.xbmcswift2b.constants import VIEW_MODES, SortMethod
...
class XBMCMixin(object):
    ...
    def cached(self, TTL=60 * 24):
        ...
        .. note:: For route caching, you should use
                  :meth:`resources.lib.xbmcswift2b.Plugin.cached_route`.
        '''
    ...
    def clear_function_cache(self):
        ...
        :meth:`resources.lib.xbmcswift2b.Plugin.cached_route` or
        :meth:`resources.lib.xbmcswift2b.Plugin.cached`.
        '''
    ...
    def list_storages(self):
        ...
        '''
        # Filter out any storages used by resources.lib.xbmcswift2b so caller doesn't corrupt
        # them.
    ...
    def _listitemify(self, item):
        '''Creates an resources.lib.xbmcswift2b.ListItem if the provided value for item is a
        dict. If item is already a valid resources.lib.xbmcswift2b.ListItem, the item is
        returned unmodified.
        '''
    ...
    def add_items(self, items):
        ...
        provided list should either be instances of resources.lib.xbmcswift2b.ListItem,
        or regular dictionaries that will be passed to
        resources.lib.xbmcswift2b.ListItem.from_dict. Returns the list of ListItems.

        :param items: An iterable of items where each item is either a
                      dictionary with keys/values suitable for passing to
                      :meth:`resources.lib.xbmcswift2b.ListItem.from_dict` or an instance of
                      :class:`resources.lib.xbmcswift2b.ListItem`.
        '''
    ...
    def end_of_directory(self, succeeded=True, update_listing=False,
        ...
        calling :meth:`~resources.lib.xbmcswift2b.Plugin.finish` will call this method.
        '''
    ...
    def add_sort_method(self, sort_method, label2_mask=None):
        ...
        You can use ``dir(resources.lib.xbmcswift2b.SortMethod)`` to list all available sort
        methods.
