'''
    resources.lib.xbmcswift2b.plugin
    -----------------
...
from resources.lib.xbmcswift2b import (xbmc, xbmcgui, xbmcplugin, xbmcaddon, Request,)
...
class Plugin(XBMCMixin):
    ...
    :param filepath: Optional parameter. If provided, it should be the path to
                     ...
                     only has an effect when resources.lib.xbmcswift2b is running on the
                     command line. Will default to the current working
                     directory since resources.lib.xbmcswift2b requires execution in the root
    ...
    def added_items(self):
        ...
        Even after repeated calls to :meth:`~resources.lib.xbmcswift2b.Plugin.add_items`, this
    ...
    @property
    def request(self):
        '''The current :class:`~resources.lib.xbmcswift2b.Request`.

        Raises an Exception if the request hasn't been initialized yet via
        :meth:`~resources.lib.xbmcswift2b.Plugin.run()`.
        '''
    ...
    def register_module(self, module, url_prefix):
        ...
        :param module: Should be an instance `resources.lib.xbmcswift2b.Module`.
