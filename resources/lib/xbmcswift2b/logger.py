'''
    resources.lib.xbmcswift2b.log
    --------------

    This module contains the resources.lib.xbmcswift2b logger as well as a convenience
...
'''
import logging
from resources.lib.xbmcswift2b import CLI_MODE
...
class XBMCFilter(object):
    ...
    def filter(self, record):
        ...
        if CLI_MODE:
            ...
            # when running in CLI
            from resources.lib.xbmcswift2b import xbmc
...
# The resources.lib.xbmcswift2b log
# Plugin writers should use plugin.log instead.
log = setup_log('resources.lib.xbmcswift2b')
